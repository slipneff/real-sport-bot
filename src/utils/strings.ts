export default {
    ...
    initials: {
        ...
        error: 'Кажется, введено что-то не то... Попробуй ещё раз',
    ...
    phone: {
        ...
        error: 'Кажется, указан неверный номер... Попробуй ещё раз',
    ...
    vk: {
        ...
        error: 'Кажется, указана неверная ссылка... Попробуй ещё раз',
    ...
    quiz: {
        ...
        start: 'Готов!',
        outOfTime: 'К сожалению, время на текущий раздел истекло...',
    },
    question: {
        dontKnow: 'Не знаю',
    },
