...
scene.hears(strings.complexity.easy, async ctx => await ctx.scene.enter(Scenes.TRAINING8_EASY));
scene.hears(strings.complexity.medium, async ctx => await ctx.scene.enter(Scenes.TRAINING8_MEDIUM));
scene.hears(strings.complexity.hard, async ctx => await ctx.scene.enter(Scenes.TRAINING8_HARD));
